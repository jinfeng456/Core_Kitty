<template>
  <div class="page-container">
    <!--新增编辑界面-->
    <el-dialog :title="$t('field.receipt.stack')"
               width="50%"
      ...
      <div class="toolbar"
        ...
        <el-form :inline="true"
                 ...
                 :size="size">
          <el-form-item>
            <el-input v-model="filters.wmsBanthNo"
                      :placeholder="$t('filters.banchNo')"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model="filters.itemName"
                      :placeholder="$t('filters.itemName')"></el-input>
          </el-form-item>
          <el-form-item>
