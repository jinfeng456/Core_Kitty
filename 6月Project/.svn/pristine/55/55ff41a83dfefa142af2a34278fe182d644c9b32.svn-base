<template>
  <div class="page-container">
      ...
      <el-form :inline="true"
        ...
        <el-form-item>
          <el-input v-model="filters.rowNumber"
                    :placeholder="$t('field.Core.corewhloc.Please enter the rowNumber')"
                    clearable></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="filters.colNumber"
                    :placeholder="$t('field.Core.corewhloc.Please enter the colNumber')"
                    clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <Ct-table :height="350"
              ...
              @handleBatchEdit="handleBatchEdit" :pageRequest="this.pageRequest">
    </Ct-table>
    <!--新增编辑界面-->
