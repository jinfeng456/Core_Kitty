<template>
  <div class="page-container">
	...
	<!--表格内容栏-->
	<kt-table2 permsDelete="core:selOut:delete" :myButtons="myButtons" :data="pageResult" :columns="filterColumns"
		@findPage="findPage" @handleExport="handleExport" @handleEdit="handleEdit" @handleDelete="handleDelete" @handleGenerate="handleGenerate" :showGenerate="true" permsGenerate="core:whProduceOut:generate" permsExport="core:whProduceOut:export" :pageRequest="this.pageRequest">
	</kt-table2>
...
export default {
	...
	data() {
		return {
			...
			myButtons:[{
				name:"handleEdit",
				perms:"core:selOut:edit",
				label:"action.edit",
				icon:"fa fa-edit"
			},{
				name:"handleDelete",
				perms:"core:selOut:delete",
				label:"action.delete",
				type:"danger",
				icon:"fa fa-trash"
			}],
