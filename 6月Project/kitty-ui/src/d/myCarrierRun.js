				   	 ...
				   	 var taskRunStatus={};
				   	  ...
				   	  function getAnchor(taskNo){
					        ...
					        var endAnchor = taskObj.endAnchor;
						   	 var corren= {x:beginAnchor.x+taskObj.move.x*taskObj.time,y:beginAnchor.y+taskObj.move.y*taskObj.time}
