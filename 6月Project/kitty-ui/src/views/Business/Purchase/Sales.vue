  ...
  <div class="page-container">
    ...
    <div class="toolbar"
      ...
      <el-form :inline="true"
        ...
        <el-form-item>
          <el-input v-model="filters.customName"
    ...
    <Wt-table :height="350"
              ...
              @handleEdit="handledeEdit" :pageRequest="this.pageRequest">
    </Wt-table>
...
import EditSalesOut from "./EditSalesOut"
export default {
  components: {
    PopupTreeInput,
    KtTableGt,
  ...
  data () {
    return {
      ...
      detailsColumns: [
        ...
        { prop: "soid", label: "订单号", minWidth: 100 },
  ...
  methods: {
    ...
    findPage: function (data) {
      ...
      this.$api.sales.findPage(this.filters).then((res) => {
    ...
    findDetailsPage: function (data) {
      ...
      this.$api.sales.findDetailsPage(params).then((res) => {
    ...
    synchronize: function (data) {
      if (this.filters.orgcode == null) {
        ...
        this.$api.sales.synchronize(this.filters).then((res) => {
          if (res.code == 200) {
    ...
    initColumns: function () {
      this.columns = [
        //{ prop: "id", label: "ID", minWidth: 50 },
        //{prop:"deptName", label:"机构", minWidth:120},
        { prop: "soNo", label: "销售订单号", minWidth: 100 },
        { prop: "customName", label: "顾客名称", minWidth: 100 },
