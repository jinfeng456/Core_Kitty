<template>
  <div class="page-container">
	...
	<kt-table2 permsDelete="core:selOut:delete" :myButtons="myButtons" :data="pageResult" :columns="filterColumns"
		@findPage="findPage" @handleExport="handleExport" @handleEdit="handleEdit" @handleDelete="handleDelete" @handleGenerate="handleGenerate" :showGenerate="true" permsGenerate="core:whSelOut:generate" permsExport="core:whSelOut:export" :pageRequest="this.pageRequest">
	</kt-table2>
