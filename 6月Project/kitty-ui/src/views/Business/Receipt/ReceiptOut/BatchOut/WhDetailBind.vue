  ...
  <div class="container">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<el-input v-model="filters.batchNo" placeholder="内部批号"></el-input>
			</el-form-item>
			<el-form-item >
...
export default {
	...
	methods: {
		...
		StockSelects:function(data){
		 	this.$api.coreStock.UpdateRecepitOutId({id:this.showReceipOutId?0:this.dataForm.id,items:data}).then((res) => {	
				 if(res.code == 200) {
