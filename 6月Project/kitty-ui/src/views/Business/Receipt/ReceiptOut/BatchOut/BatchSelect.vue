  ...
  <div class="page-container">
    ...
    <el-dialog title="批次" width="50%" :visible.sync="itemDialogVisible"    :before-close="handleClose">
      ...
      <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
          ...
          <el-form-item>
            <el-input v-model.trim="filters.batchNo"  placeholder="请输入内部批号"></el-input>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    ...
    findPage: function (data) {
      if (data !== null) {
        ...
        //this.filters.businessStatus = 1 //1.未抽检
      //   for (var i = 0; i < this.multipleTable.length; i++) {
      //   this.filters.id =this.multipleTable[i].batchId
      //   this.filters.itemId =this.multipleTable[i].itemId      
      //    }
      //   this.filters.type=this.type  //1原料,2成品
      }
