<template>
  <div class="page-container">
	<!--新增编辑界面-->
	<el-dialog :title="operation?'原料请检出库-新增':'原料请检出库-编辑'" width="80%" :visible.sync="dialogVisible" :close-on-click-modal="false" @opened="getDetials"  :before-close="handleClose">
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button  icon="el-icon-edit" :size="size"  @click.native="handleShowStock" >选择批次</el-button>
		</div>
    ...
    <batch-select  :itemDialogVisible="stockDialogVisible" @handleSelect="handleSelect" @itemHidden="itemHidden" :type=1></batch-select>
  </div>
</template>
...
      	},
		...
		handleAddDetailEdit: function () {
			...
			this.$message({ message: "出库单非执行状态无法添加明细", type: 'error' })
			}	
		},
