<template>
  <div class="page-container">
	...
	<!--表格内容栏-->
	<kt-table2  permsDelete="core:MaterialCheck:delete" :myButtons="myButtons" :data="pageResult" :columns="filterColumns" 
		@findPage="findPage" @handleEdit="handleEdit" @handleExport="handleExport" @handleDelete="handleDelete" @handleGenerate="handleGenerate" :showGenerate="true" permsGenerate="core:whMaterialCheck:generate" permsExport="core:whMaterialCheck:export" :pageRequest="this.pageRequest">
	</kt-table2>
...
export default {
	...
	data() {
		return {
			...
			myButtons:[{
				name:"handleEdit",
				perms:"core:MaterialCheck:edit",
				label:"action.edit",
				icon:"fa fa-edit"
			},{
				name:"handleDelete",
				perms:"core:MaterialCheck:delete",
				label:"action.delete",
				type:"danger",
				icon:"fa fa-trash"
			}],
	...
	methods: {
		...
		handleGenerate: function (params) {
			this.$confirm('确定生成任务吗？', '提示', {}).then(() => {
						this.$api.receipt.checkoutGenerate(params.row).then((res) => {
							if(res.code == 200) {
