<template>
  <div class="container" >
	...
	<kt-table :height="388" permsShowDetail="core:coreStock:showDetail"  permsOut="core:coreStock:out"
		...
		@findPage="findPage" @handleShowDetail="handleShowDetail" @handleOut="handleOut" :showOperation=false :showDetailandOut=true :pageRequest="this.pageRequest">
	</kt-table>	
	...
	<el-dialog :title="'库位库存信息'" width="70%" :visible.sync="editDialogVisible" :close-on-click-modal="false">
		...
		:data="pageResultDetail" :columns="detailColumns" :pageRequest="this.pageRequest">
		</kt-table-list>	
	</el-dialog>
  </div>
</template>
	...
	data() {
		return {
			...
			columns: [
				...
				//{prop:"isFull", label:"零散", minWidth:100,formatter:this.selectionFormat},
			],
			detailColumns: [
				...
				{prop:"inTime", label:"入库时间", minWidth:130,formatter:this.dateFormatDay},
				...
				//{prop:"exp", label:"保质期", minWidth:120,formatter:this.dateFormatDay},
			],
