  ...
  <div class="page-container">
	...
	<div class="menu-container" :v-if="true">
		...
		<div style="float:left;padding-left:24px;padding-top:12px;padding-bottom:4px;">
			<el-checkbox v-model="checkAll" @change="handleCheckAll" :disabled="this.selectRole.id == null"><b>{{$t('action.selectALL')}}</b></el-checkbox>
		</div>
	...
	data() {
		return {
			...
			columns: [
				...
				{prop:"name", label:"role.name", minWidth:120},
				{prop:"remark", label:"role.remark", minWidth:120},
				...
				// {prop:"lastUpdateBy", label:this.getKey('public.updateName'), minWidth:100},
				// {prop:"lastUpdateTime", label:this.getKey('public.updateTime'), minWidth:120, formatter:this.dateFormat}
			],
