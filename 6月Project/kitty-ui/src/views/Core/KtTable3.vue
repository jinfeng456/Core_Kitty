...
<template>
  ...
  <div>
    ...
    <div class="toolbar" style="padding:10px;">
      <kt-button :label="'批量打印'" :perms="permsDelete" :size="size" type="danger" @click="handleBatchDelete()" 
...
export default {
  ...
  methods: {
    ...
    // 编辑
      ...
      //item.wmsBanchNo+'|'+item.countDb+'|'+item.modelSpecs+'|'+item.itemCode+'|'+item.FromCorpBatchNo
      //+'|'+item.packUnit+'|'+item.exp+'|'+item.barCode+'| '
      let ids =[]
      debugger
