...
namespace Blog.Core.Controllers
{
    ...
    public class LoginController : Controller
    {
        ...
        public LoginController(ISysUserServices sysUserServices, ISysUserInfoServices sysUserInfoServices, IUserRoleServices userRoleServices, IRoleServices roleServices, PermissionRequirement requirement, IRoleModulePermissionServices roleModulePermissionServices)
        {
        ...
        [HttpGet]
        [Route("JWTToken3.0")]
        public async Task<BaseResult> GetJwtToken3(string account = "", string password = "")
        {
            string jwtStr = string.Empty;
            string name = account;
            ...
            if (user.Count > 0)
            {
                ...
                var tokenInfo = JwtToken.BuildJwtToken(claims.ToArray(), _requirement);
